        ...
        if '<table class="subTable" style="width:100%;">' in wrapper.get_attribute('innerHTML'):
            try:
                ...
                if officer_trs[0].find_element_by_tag_name('td').text == 'Name':
                    if len(officer_trs) > 2:
                        for i in range(len(officer_trs)):
                            if i != 0:
                                officer_tds = officer_trs[i].find_elements_by_tag_name('td')
                        ...
                        main_tr = driver.find_element_by_xpath('//*[@id="printDiv2"]/table[3]/tbody/tr[2]')
